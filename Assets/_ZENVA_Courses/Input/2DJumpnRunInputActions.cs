...
//     version 1.18.0
//     from Assets/_ZENVA_Courses/Input/2DJumpnRunInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_ZENVA_Courses/Input/2DJumpnRunInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @_2DJumpnRunInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @_2DJumpnRunInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""2DJumpnRunInputActions"",
    ""maps"": [
        {
    ...
    ""controlSchemes"": [
        ...
        m_PlayerCharacter_Previous = m_PlayerCharacter.FindAction("Previous", throwIfNotFound: true);
        m_PlayerCharacter_Next = m_PlayerCharacter.FindAction("Next", throwIfNotFound: true);
    ...
    ~@_2DJumpnRunInputActions()
    {
        UnityEngine.Debug.Assert(!m_PlayerCharacter.enabled, "This will cause a leak and performance issues, _2DJumpnRunInputActions.PlayerCharacter.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, _2DJumpnRunInputActions.UI.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_PlayerCharacter_Previous;
    private readonly InputAction m_PlayerCharacter_Next;
    ...
    {
        private @_2DJumpnRunInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerCharacterActions(@_2DJumpnRunInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        ...
        /// <summary>
        /// Provides access to the underlying input action "PlayerCharacter/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_PlayerCharacter_Previous;
        /// <summary>
        /// Provides access to the underlying input action "PlayerCharacter/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_PlayerCharacter_Next;
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@_2DJumpnRunInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
